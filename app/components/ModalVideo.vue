<template>
  <div class="modal" @click.self="closeModal">
    ...
    <div class="modal-container" :style="{'--widthModal': (maxWidth) ? maxWidth + 'px' : '847px' }">
      <div class="modal-content">
        <div class="clock-loader-wrap">          
          <div class="clock-loader"></div>
        </div>
        <iframe class="modal-video" width="100%" height="100%" :src="`https://www.youtube.com/embed/${videoId}?autoplay=1`" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
  </div>
</template>
